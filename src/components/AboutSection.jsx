...
const AboutSection = () => {
  const features = [
    ...
    {
      id: 2,
      icon: <FaGlobe className="w-8 h-8 text-red-600" />,
      number: "02",
    ...
    <div className="relative z-10 p-8 lg:p-12 bg-white/70 backdrop-blur-sm rounded-lg border border-gray-100 shadow-md">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {features.map((feature, index) => (
          ...
          >
            {/* Icon Container */}
            <div className="flex-shrink-0 mb-6 p-3 bg-red-50 rounded-full group-hover:bg-red-100 transition-colors duration-300">
  ...
  <div className="relative order-1 lg:order-2">
    ...
    <motion.div 
      className="mt-8 bg-gradient-to-r from-red-600 to-red-700 p-5 rounded-xl shadow-lg border border-red-500"
      initial={{ opacity: 0, y: 30 }}
      whileInView={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.8, delay: 0.2, ease: "easeOut" }}
      viewport={{ once: true }}
